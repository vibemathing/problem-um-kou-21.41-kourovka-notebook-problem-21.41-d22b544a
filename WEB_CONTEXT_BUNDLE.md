...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.41"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-v1",
      "problem_contract_sha256": "0b8edcb7d4f6ac897c7318cd87fc8126465e9e0a3b2c24f95450a3024270dcf1",
      "problem_id": "problem:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a",
      "route_id": "route:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-source-fidelity-01",
      "graph_id": "graph:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "A group is said to be self-similar if it admits a faithful state-closed representation by automorphisms of a regular one-rooted m-tree for some m. Can a torsion-free finitely presented metabelian group which is self-similar contain a subgroup isomorphic to the restricted wreath product H = $\\mathbb Z\\wr\\mathbb Z$?"
          },
          "statement_sha256": "c9cb524c57e313fb02f52e1758723e74f2431874f2adb5a5dcbf41ea61729251"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-root",
      "route_id": "route:um-kou-21.41-kourovka-notebook-problem-21.41-d22b544a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.41-73f80888abbb",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.41"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
